...
do
	...
	# 16S
	blastn -query $i -db $pro/16S_db/NCBI-16S/blast_db/NCBI-16S-18998 -out $name\_blastn_16S.out -outfmt 6 -evalue 1e-5 -num_threads 6 -max_target_seqs 5
	...
	# ITS
	blastn -query $i -db $pro/ITS_db/NCBI-refseq-targetedloci/blast_db/fungi.ITS -out $name\_blastn_ITS.out -outfmt 6 -evalue 1e-5 -num_threads 6 -max_target_seqs 5
